...
public class POSIntegrado extends Serial {
    ...
    public MultiCodeSaleResponse multiCodeSale(int amount, String ticket, long commerceCode, boolean sendVoucher, boolean sendStatus) throws TransbankMultiCodeSaleException {
        ...
        String command = String.format("0270|%s|%s||%s|%s|%s|", amount, ticket, printVoucher, sendIntermediateMsg, commerceCode);
